...
/**
 * Okno, które zawiera panel "PentominosPanel" oraz jego pasek menu.
 * Ta klasa posiada główny program, który po prostu otwiera okno.
 */
public class Pentominos extends JFrame {
   ...
   private void setBoardSize(int rows, int cols) {
      ...
      if (squareHeight < squareWidth)
         bounds.width = 4 + cols*squareHeight; 
      Dimension screensize = Toolkit.getDefaultToolkit().getScreenSize();
